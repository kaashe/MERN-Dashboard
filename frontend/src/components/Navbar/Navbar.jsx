                ...
                <div className="container flex flex-row justify-around my-6" style={{ backgroundColorL: 'red' }}>
                    ...
                    <nav>
                        <ul className='flex flex-row gap-4'>
                            ...
                            {!token &&  <li className='text-purple-500'><NavLink className='navLink' to="sign-Up">Sign-Up</NavLink></li>}
                            {!token &&  <li className='text-purple-500'><NavLink className='navLink' to="/sign-In">Sign-In</NavLink></li>}
