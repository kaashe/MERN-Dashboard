...
const EditContacts = () => {
    ...
    const onSubmit = async (data) => {
        ...
        SetShowLoading(true)
        try {
            const response = await fetch(`http://localhost:3000/api/admin/contact/${id}/update`, {
                method: 'PATCH',
                headers: {
            ...
            if (response.ok) {
                ...
                setNotification({ message: 'contact Updated successfuly!', type: 'success' });
            ...
            setNotification({ message: "Can't Update contact, Failed!", type: 'error' });
        }
        SetShowLoading(false)
    };
    useEffect(() => {
    ...
    const getSingleContact = async () => {
        await fetch(`http://localhost:3000/api/admin/contact/${id}/edit`, {
            method: "GET",
            headers: {
